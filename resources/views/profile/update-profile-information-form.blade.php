<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <!-- Username -->
        <div class="col-span-6 sm:col-span-4">
            <!--<label for="name"  >{{ __('Kan Grubu') }}</label> -->

            <x-jet-label for="blood" value="{{ __('Kan Grubu') }}" />
            <x-jet-input id="blood" type="text" class="mt-1 block w-full  " disabled wire:model.defer="state.blood"
                autocomplete="blood" />
